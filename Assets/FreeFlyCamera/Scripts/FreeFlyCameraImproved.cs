using UnityEngine;
using UnityEngine.EventSystems;  // Adicione esta linha para usar o EventSystem

[RequireComponent(typeof(Camera))]
public class FreeFlyCameraImproved : MonoBehaviour
{
    #region UI
    ...
    private void Update()
    {
        ...
        // Se o cursor estiver visível (fora da UI), permite a movimentação da câmera
        if (Cursor.visible)
            return;
